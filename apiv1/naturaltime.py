...
class NaturalTimeFormatter:
    time_strings = {
        ...
        "past-day": gettext_lazy("%(delta)s oldin"),
        # Translators: please keep a non-breaking space (U+00A0) between count
        # and time unit.
        "past-hour": ngettext_lazy("1 soat oldin", "%(count)s soat oldin", "count"),
        # Translators: please keep a non-breaking space (U+00A0) between count
        # and time unit.
        "past-minute": ngettext_lazy("1 minut oldin", "%(count)s minut oldin", "count"),
        # Translators: please keep a non-breaking space (U+00A0) between count
        # and time unit.
        "past-second": ngettext_lazy("1 sekund oldin", "%(count)s sekund oldin", "count"),
        "now": gettext_lazy("Hozir"),
        # Translators: please keep a non-breaking space (U+00A0) between count
        # and time unit.
        "future-second": ngettext_lazy(
            "1 sekund oldin", "%(count)s sukund oldin", "count"
        ),
        # Translators: please keep a non-breaking space (U+00A0) between count
        # and time unit.
        "future-minute": ngettext_lazy(
            "bir daqiqadan keyin", "%(count)s daqiqadan keyin", "count"
        ),
        # Translators: please keep a non-breaking space (U+00A0) between count
        # and time unit.
        "future-hour": ngettext_lazy(
            "1 soatdan keyin", "%(count)s soatdan keyin", "count"
        ),
        # Translators: delta will contain a string like '2 months' or '1 month, 2 weeks'
        "future-day": gettext_lazy("%(delta)s bundan buyon"),
    }
    past_substrings = {
        # Translators: 'naturaltime-past' strings will be included in '%(delta)s ago'
        "year": npgettext_lazy(
            "naturaltime-past", "%(num)d yil", "%(num)d yil", "num"
        ),
        "month": npgettext_lazy(
            "naturaltime-past", "%(num)d oy", "%(num)d oy", "num"
        ),
        "week": npgettext_lazy(
            "naturaltime-past", "%(num)d hafta", "%(num)d hafta", "num"
        ),
        "day": npgettext_lazy("naturaltime-past", "%(num)d kun", "%(num)d kun", "num"),
        "hour": npgettext_lazy(
            "naturaltime-past", "%(num)d soat", "%(num)d soat", "num"
        ),
        "minute": npgettext_lazy(
            "naturaltime-past", "%(num)d minut", "%(num)d minut", "num"
        ),
    }
    future_substrings = {
        ...
        # '%(delta)s from now'.
        "year": npgettext_lazy(
            "naturaltime-future", "%(num)d yil", "%(num)d yil", "num"
        ),
        "month": npgettext_lazy(
            "naturaltime-future", "%(num)d oy", "%(num)d oy", "num"
        ),
        "week": npgettext_lazy(
            "naturaltime-future", "%(num)d hafta", "%(num)d hafta", "num"
        ),
        "day": npgettext_lazy(
            "naturaltime-future", "%(num)d kun", "%(num)d kun", "num"
        ),
        "hour": npgettext_lazy(
            "naturaltime-future", "%(num)d soat", "%(num)d soat", "num"
        ),
        "minute": npgettext_lazy(
            "naturaltime-future", "%(num)d minut", "%(num)d minut", "num"
        ),
    }
