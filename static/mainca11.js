                ...
                try{
                    ...
                    for(let [key, value] of Object.entries(data)){
                        for(let [key1, value1] of Object.entries(value)){
                            html += `
                                <a class="dropdown-item href="${value1.url}">${key1} - ${value1.messages}</a>
                            `;
                        };
                    };}else{
                        html = '<a class="dropdown-item" href="#">Sizda hech qanday bildirishnoma yo\'q</a>';
                    };
...
try{
    document.querySelector('.user-menu-opener').addEventListener('click', ()=>{
        document.querySelector('.profile-items').classList.toggle('show-with-js')
    });
} catch (e){};